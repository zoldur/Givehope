...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='givehope.conf'
CONFIGFOLDER='/root/.givehope'
COIN_DAEMON='givehoped'
COIN_CLI='givehope-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/givehopecoin/GiveHopeCore/releases/download/v1.0.0.0/givehope-linux-cli.tgz'
...
#Nodes
addnode=158.69.223.139
addnode=104.168.167.66
addnode=95.179.202.146
addnode=199.247.9.174
addnode=144.202.48.152
addnode=45.63.65.67
EOF
}
